...
class SBuild(implicit _project: Project) {
  ...
  Plugin[org.sbuild.plugins.sbuildplugin.SBuildPlugin] configure { _.copy(
    sbuildVersion = "0.7.1",
    pluginClass = s"${namespace}.Asciidoctor",
  ...
  Plugin[MavenDeploy] configure { _.copy(
    ...
    version = version,
    artifactName = Some("SBuild Asciidoctor Plugin"),
    description = Some("An SBuild Plugin that integrates Asciidoctor static site generator."),
